...
resourcestring
  ...
  S_WRONG_SETTINGS = 'Compiler, Preprocessor, Linker and/or start database not found. Please check paths in the "Compiler" tab in Tools/Options menu.';
  ...
  S_COPYRIGHT = 'Superglus Editor (C) 2016 Uto';
  ...
  S_ASSEMBLER_NOT_FOUND = 'Assembler nor found, please check options to set valid path';
  S_LINKER_NOT_FOUND = 'Linker (blorb packager) not found, please check options to set valid path';
  ...
  S_STARTING_ASSEMBLER = 'Running assembler...';
  S_STARTING_COMPILER = 'Running compiler...';
  S_STARTING_LINKER = 'Running blorb packager...';
  S_COMPILE_OK = 'OK. Ready to run.';
  S_BLORB_FAIL = 'Unable to build blorb file, blc packaging failed.';
  S_ASSEMBLER_FAIL = 'Unable to build ulx file, .ula File malformed, please check plugins.';
  S_GAME_BUILT = 'OK. Ready to run.';
